...
public class JwtAuthorizationTokenFilter extends OncePerRequestFilter {
	...
	public JwtAuthorizationTokenFilter(@Qualifier("jwtUserService") UserDetailsService userDetailsService, JwtTokenUtil jwtTokenUtil, @Value("${jwt.header}") String tokenHeader) {
